...
@Component({
  selector: 'app-mini-why-choose-us',
  templateUrl: './mini-why-choose-us.component.html',
  styleUrls: ['./mini-why-choose-us.component.scss']
})
export class MiniWhyChooseUsComponent {
