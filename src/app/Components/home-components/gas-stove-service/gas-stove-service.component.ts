...
export class GasStoveServiceComponent {
  ...
  gasStoveServices = [
    { 
      serviceImage:['assets/ home-services-images/gas stove repair.png',
        'assets/ home-services-images/gas stove repair.png',
        'assets/ home-services-images/gas stove repair.png',
    ...
    },
    {
      serviceImage:['assets/ home-services-images/gas stove steam cleaning.png',
        'assets/ home-services-images/gas stove steam cleaning.png',
      ],
  ...
  openDialog(service: any): void {
    const dialogRef = this.dialog.open(GasstoveServiceDetailDialogComponent, {
      width: '500px',
      height: '600px',
      maxWidth: '90vw',
      maxHeight: '80vh',
