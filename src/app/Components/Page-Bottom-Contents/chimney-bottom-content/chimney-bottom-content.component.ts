...
@Component({
  selector: 'app-chimney-bottom-content',
  templateUrl: './chimney-bottom-content.component.html',
  styleUrls: ['./chimney-bottom-content.component.scss']
})
export class ChimneyBottomContentComponent {
  isExpanded = false;
