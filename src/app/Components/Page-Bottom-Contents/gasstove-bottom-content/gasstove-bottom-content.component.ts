...
@Component({
  selector: 'app-gasstove-bottom-content',
  templateUrl: './gasstove-bottom-content.component.html',
  styleUrls: ['./gasstove-bottom-content.component.scss']
})
export class GasstoveBottomContentComponent {
  isExpanded = false;
